            ...
            <section>
                ...
                <div class="woof-section-title">
                    <div class="col-title">
                        ...
                        <p class="description"><?php esc_html_e('WOOF Filter Elements Constructor', 'woocommerce-products-filter') ?></p>
                    </div>
                ...
                <div class="woof-notice">
                    <?php printf(esc_html__('Notice: This extension works for now only with taxonomies and its functionality will be extended with new element types, and also with meta data elements. WOOF SD has %s. If you have an idea about HTML element(s) you want to see in WOOF filter elements constructor discuss please your suggestion using %s.', 'woocommerce-products-filter'), '<a href="https://demo-sd.products-filter.com/woof-sd-gallery/" target="_blank">' . esc_html__('gallery of custom-element types', 'woocommerce-products-filter') . '</a>', '<a href="https://pluginus.net/support/forum/woof-woocommerce-products-filter/" target="_blank">' . esc_html__('WOOF support forum', 'woocommerce-products-filter') . '</a>') ?>
                </div>
