    ...
    public function __construct() {
        ...
        add_action('woof_print_applications_tabs_content_smart_designer', function () {
            ...
            if ($this->db->query($sql) === false) {
                $data['error'] = esc_html__("WOOF cannot create database table for smart designer! Make sure that your mysql user has the CREATE privilege! Do it manually using your host panel and phpmyadmin!", 'woocommerce-products-filter');
